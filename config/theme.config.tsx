...
export const metaTags = (
  ...
  description = description ? description : website.description ? website.description : '';
  
  const userScalable = scalable ? ", user-scalable="+scalable : ", user-scalable=no";
  
  const viewport = "width=device-width, initial-scale=1.0, maximum-scale=1.0" + userScalable;
